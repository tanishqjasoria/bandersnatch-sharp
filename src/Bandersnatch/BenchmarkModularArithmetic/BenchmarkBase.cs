...
using Nethermind.MontgomeryField.obsolete;
...
public class BenchmarkBase
{
    ...
    public static BigInteger bMod = FpE._modulus.Value;
    public static UInt256 uMod = (UInt256)bMod;
}
...
public class Inverse : ThreeParamBenchmarkBase
{
    ...
    [Benchmark]
    public UInt256 Inversed_UInt256()
    {
        UInt256.ExpMod(A.Item2, B.Item2, uMod, out UInt256 res);
        return res;
    }
...
// [SimpleJob(RuntimeMoniker.Net60)]
// [MemoryDiagnoser]
// public class Double : ThreeParamBenchmarkBase
// {
//     [Benchmark(Baseline = true)]
//     public BigInteger Double_BigInteger()
//     {
//         return BigInteger.ModPow(A.Item1, B.Item1, bMod);
//     }
//
//     [Benchmark]
//     public UInt256 Double_UInt256()
//     {
//         UInt256.ExpMod(A.Item2, B.Item2, uMod, out UInt256 res);
//         return res;
//     }
//
//     [Benchmark]
//     public TestElement Double_Element()
//     {
//         UInt256.ExpMod(A.Item2, B.Item2, uMod, out UInt256 res);
//         return res;
//     }
